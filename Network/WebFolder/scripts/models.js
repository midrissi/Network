(function($, window) {
  ...
  /**
   * Call the double click event passed in when instantiating
   * a new node. Can be used to trigger other events
   * specific to the diagram.
   */
  ...
  Node.prototype.onDragStart = function(e) {
    ...
    if(this.stage.css('position') === 'absolute'){
    	var pos = this.stage.position();
    	this.clickCoords.x += pos.left;
    	this.clickCoords.y += pos.top;
    }
  };
  ...
  Node.prototype.onDrag = function(e) {
    ...
    this.setPosition();
    (this.events.drag || this.events.base).call(this);
  };
  ...
  Node.prototype.onDragEnd = function(e) {
    ...
    (this.events.drop || this.events.base).call(this);
  };
